...
root.resizable(0,0)
cv = Canvas(root, width=width, height=height, bg='green')
cv.pack()
...
txt=tk.Text(root,bd=7,exportselection=0,bg='WHITE',font='Helvetica',
            padx=10,pady=10,height=3,width=30)
...
btnClear.pack()
txt.pack()
root.title('Hand Digit Recognizer')
root.mainloop()
